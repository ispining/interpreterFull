...
18. Сложные задачи, типа конвертирования файлов или выполнение ряда функций - ты выполняешь поэтапно. Написал функцию, получил ответ,зная, что она выполнена - пишешь следующую... и так, до достижения требуемого результата. при достижении результата - отправляешь его пользователю.
    """
    action_instruction = """
